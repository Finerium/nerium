...
<!-- SKILL ORIGIN: https://github.com/chongdashu/phaserjs-oakwoods -->
<!-- LICENSE: MIT (see _skills_staging/phaserjs-oakwoods/LICENSE for upstream) -->
<!-- TRANSPLANTED BY: Talos on 2026-04-23 -->
<!-- ADAPTATION: copied verbatim; NERIUM usage guidance is appended via agent prompts (thalia-v2, nemea-rv-a/b) rather than editing the skill body. -->
...
(anti-pattern) **Testing the wrong layer**: E2E tests for pure logic
